                ...
                <table class="table table-bordered table-striped table-hover table-xs">
                    <thead class="bg-primary">
                        <tr>
                            ...
                            <th class="text-center">Abasen Masuk</th>
                            <th class="text-center">Abasen pulang</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{-- Label Keterangan --}}
                                <span
                                    @if ($p->ket == 'Hadir') class="label bg-success"
                                    @elseif ($p->ket == 'Alpha') class="label bg-danger"
                                    @elseif ($p->ket == 'Cuti') class="label bg-info"
                                    @endif
                                    >
                                    {{ $p->ket }}
                                </span>
                                ...
                                <span class="label bg-purple-600">WFH</span>
                                @endif

                                {{-- Label Terlambat --}}
                                @if ($p->ket == 'Hadir' && $p->jam_dtg > '08:30')
                                <span class="label bg-warning-600">Terlambat</span>
                                @endif
                            </td>
                            <td class="text-center">
                                @if ($p->ket == 'Hadir')
                                {{ date('H:i', strtotime($p->jam_dtg))}}
                                @else
                                -
                                @endif
                            </td>
                                ...
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="{{ route('presensi.pulang', $p->id) }}"
                                                    onclick="return confirm('Yakin ingin absen pulang sekarang?')">
                                                    <i class="icon-file-plus"></i> Absen Pulang
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
