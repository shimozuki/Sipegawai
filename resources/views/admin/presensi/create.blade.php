            ...
            <form action="{{ route('presensi.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="select" disabled>
                        <option value="{{ $pegawaiLogin->id }}">{{ $pegawaiLogin->nama }}</option>
                    </select>
                    <!-- Hidden input to actually submit the ID -->
                    <input type="hidden" name="id_pegawai" value="{{ $pegawaiLogin->id }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input type="date" name="tanggal_tampil" class="form-control" value="{{ date('Y-m-d') }}" disabled>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_dtg_tampil" class="form-control" value="{{ date('H:i') }}" disabled>
                            <input type="hidden" name="jam_dtg" value="{{ date('H:i') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {{-- Tampilkan field jika sudah lewat jam 16:30 --}}
                            <input type="time" name="jam_plg_tampil" class="form-control" value="{{ $now->format('H:i') }}" disabled>
                            <input type="hidden" name="jam_plg" value="{{ $now->format('H:i') }}">
                            @else
                            {{-- Kosongkan field jika belum waktunya --}}
                            <input type="time" name="jam_plg" class="form-control" disabled placeholder="Belum waktunya pulang">
                            @endif
